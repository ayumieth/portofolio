              ...
              <div className="-mx-4 flex flex-wrap lg:justify-between">
                <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                  <div className="mb-12 max-w-[570px] lg:mb-0">
                    <span className="text-primary mb-4 block text-base font-semibold dark:text-white">
                      {t('CONTACT_US')}
                    </span>
                    <h2
                      className="dark:text-white text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                    >
                      {t('GET_IN')}
                    </h2>
                    <p className="text-body-color mb-9 text-base leading-relaxed dark:text-white">
                      {t('LOREM')}
                    </p>
                    <div className="mb-8 flex w-full max-w-[370px]">
                      ...
                      <div className="w-full">
                        <h4 className="text-dark mb-1 text-xl font-bold dark:text-white">{t('OUT_LOCATION')}</h4>
                    ...
                    <div className="mb-8 flex w-full max-w-[370px]">
                      ...
                      <div className="w-full dark:text-white">
                        <h4 className="text-dark mb-1 text-xl font-bold">{t('PHONE_NUMBER')}</h4>
                    ...
                    <div className="mb-8 flex w-full max-w-[370px]">
                      ...
                      <div className="w-full dark:text-white">
                        <h4 className="text-dark mb-1 text-xl font-bold">{t('EMAIL')}</h4>
                  ...
                  <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                    <form>
                      ...
                      <div>
                        <button
                          type="submit"
                          className="dark:text-gray-900 bg-primary border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                        >
                          {t('SEND')}
                        </button>
                      </div>
